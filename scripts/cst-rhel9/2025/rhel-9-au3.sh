...
#
# CONTROL: Ensue that audit records contain information that establishes the
# following:
...
controlid="AU-3 Content of Audit Records"
...
title1c="Expecting: ${YLO}Nothing returned
           If output is produced and the accounts listed are interactive user accounts, this is a finding."${BLD}
...
title2a="RHEL 9 must label all offloaded audit logs before sending them to the central log server."
title2b="Checking with: grep name_format /etc/audit/auditd.conf"
title2c="Expecting: ${YLO}name_format = hostname
           NOTE: If the \"name_format\" option is not \"hostname\", \"fqd\", or \"numeric\", or the line is commented out, this is a finding."${BLD}
cci2="CCI-000132 CCI-001851"
stigid2="RHEL-09-653060"
severity2="CAT II"
ruleid2="SV-258161r958416"
vulnid2="V-258161"

title3a="RHEL 9 must produce audit records containing information to establish the identity of any individual or process associated with the event."
title3b="Checking with: grep log_format /etc/audit/auditd.conf"
title3c="Expecting: ${YLO}log_format = ENRICHED
           NOTE: If the \"log_format\" option is not \"ENRICHED\", or the line is commented out, this is a finding."${BLD}
cci3="CCI-000366 CCI-001487"
stigid3="RHEL-09-653100"
severity3="CAT II"
ruleid3="SV-258169r991556"
vulnid3="V-258169"

title4a="RHEL 9 must enable auditing of processes that start prior to the audit daemon."
title4b="Checking with: grubby --info=ALL | grep args | grep -v 'audit=1'"
title4c="Expecting: ${YLO}Nothing returned
           NOTE: If any output is returned, this is a finding."${BLD}
cci4="CCI-000130 CCI-000135 CCI-000169 CCI-000172 CCI-001464 CCI-002884"
stigid4="RHEL-09-212055"
severity4="CAT III"
ruleid4="SV-257796r1044847"
vulnid4="V-257796"

title5a="RHEL 9 audit package must be installed."
title5b="Checking with: dnf list --installed audit"
title5c="Expecting: ${YLO}(example) audit-3.0.7-101.el9_0.2.x86_64
           NOTE: If the \"audit\" package is not installed, this is a finding."${BLD}
cci5="CCI-000130 CCI-000131 CCI-000132 CCI-000133 CCI-000134 CCI-000135 CCI-000154 CCI-000158 CCI-000159 CCI-000169 CCI-000172 CCI-001464 CCI-001487 CCI-003938 CCI-001875 CCI-001876 CCI-001877 CCI-001878 CCI-001879 CCI-001880 CCI-001881 CCI-001882 CCI-001889 CCI-001914 CCI-002884 CCI-001814"
stigid5="RHEL-09-653010"
severity5="CAT II"
ruleid5="SV-258151r1045298"
vulnid5="V-258151"

title6a="RHEL 9 audit service must be enabled."
...
cci6="CCI-000130 CCI-000131 CCI-000132 CCI-000133 CCI-000134 CCI-000135 CCI-000154 CCI-000158 CCI-000169 CCI-000172 CCI-001464 CCI-001487 CCI-003938 CCI-001876 CCI-001877 CCI-001878 CCI-001879 CCI-001880 CCI-001881 CCI-001882 CCI-001889 CCI-001914 CCI-002884 CCI-004188"
stigid6="RHEL-09-653015"
severity6="CAT II"
ruleid6="SV-258152r1015127"
vulnid6="V-258152"

title7a="RHEL 9 must audit all uses of the chmod, fchmod, and fchmodat system calls."
title7b="Checking with: auditctl -l | grep chmod"
...
cci7="CCI-000130 CCI-000135 CCI-000169 CCI-000172 CCI-002884"
stigid7="RHEL-09-654015"
severity7="CAT II"
ruleid7="SV-258177r1106368"
vulnid7="V-258177"

title8a="RHEL 9 must audit all uses of the chown, fchown, fchownat, and lchown system calls."
title8b="Checking with: auditctl -l | grep chown"
...
stigid8="RHEL-09-654020"
severity8="CAT II"
ruleid8="SV-258178r1106370"
vulnid8="V-258178"

title9a="RHEL 9 must audit all uses of the setxattr, fsetxattr, lsetxattr, removexattr, fremovexattr, and lremovexattr system calls."
title9b="Checking with: auditctl -l | grep xattr"
...
stigid9="RHEL-09-654025"
severity9="CAT II"
ruleid9="SV-258179r1106371"
vulnid9="V-258179"

title10a="RHEL 9 must audit all uses of umount system calls."
title10b="Checking with: auditctl -l | grep /usr/bin/umount"
...
cci10="CCI-000130 CCI-000169 CCI-000172 CCI-002884"
stigid10="RHEL-09-654030"
severity10="CAT II"
ruleid10="SV-258180r1045325"
vulnid10="V-258180"

title11a="RHEL 9 must audit all uses of the chacl command."
title11b="Checking with: auditctl -l | grep chacl"
...
stigid11="RHEL-09-654035"
severity11="CAT II"
ruleid11="SV-258181r1045328"
vulnid11="V-258181"

title12a="RHEL 9 must audit all uses of the setfacl command."
title12b="Checking with: auditctl -l | grep setfacl"
...
stigid12="RHEL-09-654040"
severity12="CAT II"
ruleid12="SV-258182r1045331"
vulnid12="V-258182"

title13a="RHEL 9 must audit all uses of the chcon command."
title13b="Checking with: auditctl -l | grep chcon"
...
stigid13="RHEL-09-654045"
severity13="CAT II"
ruleid13="SV-258183r1045334"
vulnid13="V-258183"

title14a="RHEL 9 must audit all uses of the semanage command."
title14b="Checking with: auditctl -l | grep semanage"
...
stigid14="RHEL-09-654050"
severity14="CAT II"
ruleid14="SV-258184r1045337"
vulnid14="V-258184"

title15a="RHEL 9 must audit all uses of the setfiles command."
title15b="Checking with: auditctl -l | grep setfiles"
...
stigid15="RHEL-09-654055"
severity15="CAT II"
ruleid15="SV-258185r1045340"
vulnid15="V-258185"

title16a="RHEL 9 must audit all uses of the setsebool command."
title16b="Checking with: auditctl -l | grep setsebool"
...
stigid16="RHEL-09-654060"
severity16="CAT II"
ruleid16="SV-258186r1045343"
vulnid16="V-258186"

title17a="RHEL 9 must audit all uses of the rename, unlink, rmdir, renameat, and unlinkat system calls."
title17b="Checking with: auditctl -l | grep 'rename\|unlink\|rmdir'"
...
stigid17="RHEL-09-654065"
severity17="CAT II"
ruleid17="SV-258187r1106373"
vulnid17="V-258187"

title18a="RHEL 9 must audit all uses of the truncate, ftruncate, creat, open, openat, and open_by_handle_at system calls."
title18b="Checking with: auditctl -l | grep 'open\\\\b\|openat\|open_by_handle_at\|truncate\|creat'"
...
stigid18="RHEL-09-654070"
severity18="CAT II"
ruleid18="SV-258188r1106375"
vulnid18="V-258188"

title19a="RHEL 9 must audit all uses of the delete_module system call."
title19b="Checking with: auditctl -l | grep delete_module"
...
stigid19="RHEL-09-654075"
severity19="CAT II"
ruleid19="SV-258189r1106377"
vulnid19="V-258189"

title20a="RHEL 9 must audit all uses of the init_module and finit_module system calls."
title20b="Checking with: auditctl -l | grep init_module"
...
stigid20="RHEL-09-654080"
severity20="CAT II"
ruleid20="SV-258190r1106379"
vulnid20="V-258190"

title21a="RHEL 9 must audit all uses of the chage command."
title21b="Checking with: auditctl -l | grep chage"
...
stigid21="RHEL-09-654085"
severity21="CAT II"
ruleid21="SV-258191r1045358"
vulnid21="V-258191"

title22a="RHEL 9 must audit all uses of the chsh command."
title22b="Checking with: auditctl -l | grep chsh"
...
stigid22="RHEL-09-654090"
severity22="CAT II"
ruleid22="SV-258192r1045361"
vulnid22="V-258192"

title23a="RHEL 9 must audit all uses of the crontab command."
title23b="Checking with: auditctl -l | grep crontab"
...
stigid23="RHEL-09-654095"
severity23="CAT II"
ruleid23="SV-258193r1045364"
vulnid23="V-258193"

title24a="RHEL 9 must audit all uses of the gpasswd command."
title24b="Checking with: auditctl -l | grep gpasswd"
...
stigid24="RHEL-09-654100"
severity24="CAT II"
ruleid24="SV-258194r1045367"
vulnid24="V-258194"

title25a="RHEL 9 must audit all uses of the kmod command."
title25b="Checking with: auditctl -l | grep kmod"
...
stigid25="RHEL-09-654105"
severity25="CAT II"
ruleid25="SV-258195r1045370"
vulnid25="V-258195"

title26a="RHEL 9 must audit all uses of the newgrp command."
title26b="Checking with: auditctl -l | grep newgrp"
...
stigid26="RHEL-09-654110"
severity26="CAT II"
ruleid26="SV-258196r1045373"
vulnid26="V-258196"

title27a="RHEL 9 must audit all uses of the pam_timestamp_check command."
title27b="Checking with: auditctl -l | grep timestamp"
...
stigid27="RHEL-09-654115"
severity27="CAT II"
ruleid27="SV-258197r1045376"
vulnid27="V-258197"

title28a="RHEL 9 must audit all uses of the passwd command."
title28b="Checking with: auditctl -l | egrep '(/usr/bin/passwd)'"
...
stigid28="RHEL-09-654120"
severity28="CAT II"
ruleid28="SV-258198r1045379"
vulnid28="V-258198"

title29a="RHEL 9 must audit all uses of the postdrop command."
title29b="Checking with: auditctl -l | grep postdrop"
...
stigid29="RHEL-09-654125"
severity29="CAT II"
ruleid29="SV-258199r1045382"
vulnid29="V-258199"

title30a="RHEL 9 must audit all uses of the postqueue command."
title30b="Checking with: auditctl -l | grep postqueue"
...
stigid30="RHEL-09-654130"
severity30="CAT II"
ruleid30="SV-258200r1045385"
vulnid30="V-258200"

title31a="RHEL 9 must audit all uses of the ssh-agent command."
title31b="Checking with: auditctl -l | grep ssh-agent"
...
stigid31="RHEL-09-654135"
severity31="CAT II"
ruleid31="SV-258201r1045388"
vulnid31="V-258201"

title32a="RHEL 9 must audit all uses of the ssh-keysign command."
title32b="Checking with: auditctl -l | grep ssh-keysign"
...
stigid32="RHEL-09-654140"
severity32="CAT II"
ruleid32="SV-258202r1045391"
vulnid32="V-258202"

title33a="RHEL 9 must audit all uses of the su command."
title33b="Checking with: auditctl -l | grep '/usr/bin/su\\\\b'"
...
stigid33="RHEL-09-654145"
severity33="CAT II"
ruleid33="SV-258203r1045394"
vulnid33="V-258203"

title34a="RHEL 9 must audit all uses of the sudo command."
title34b="Checking with: auditctl -l | grep '/usr/bin/sudo\\\\b'"
...
stigid34="RHEL-09-654150"
severity34="CAT II"
ruleid34="SV-258204r1045397"
vulnid34="V-258204"

title35a="RHEL 9 must audit all uses of the sudoedit command."
title35b="Checking with: auditctl -l | grep /usr/bin/sudoedit"
...
stigid35="RHEL-09-654155"
severity35="CAT II"
ruleid35="SV-258205r1045400"
vulnid35="V-258205"

title36a="RHEL 9 must audit all uses of the unix_chkpwd command."
title36b="Checking with: auditctl -l | grep unix_chkpwd"
...
stigid36="RHEL-09-654160"
severity36="CAT II"
ruleid36="SV-258206r1045403"
vulnid36="V-258206"

title37a="RHEL 9 must audit all uses of the unix_update command."
title37b="Checking with: auditctl -l | grep unix_update"
...
stigid37="RHEL-09-654165"
severity37="CAT II"
ruleid37="SV-258207r1045406"
vulnid37="V-258207"

title38a="RHEL 9 must audit all uses of the userhelper command."
title38b="Checking with: auditctl -l | grep userhelper"
...
stigid38="RHEL-09-654170"
severity38="CAT II"
ruleid38="SV-258208r1045409"
vulnid38="V-258208"

title39a="RHEL 9 must audit all uses of the usermod command."
title39b="Checking with: auditctl -l | grep usermod"
...
stigid39="RHEL-09-654175"
severity39="CAT II"
ruleid39="SV-258209r1045412"
vulnid39="V-258209"

title40a="RHEL 9 must audit all uses of the mount command."
title40b="Checking with: auditctl -l | grep /usr/bin/mount"
...
stigid40="RHEL-09-654180"
severity40="CAT II"
ruleid40="SV-258210r1045415"
vulnid40="V-258210"

title41a="Successful/unsuccessful uses of the umount system call in RHEL 9 must generate an audit record."
title41b="Checking with: auditctl -l | grep b32 | grep 'umount\\\\b'"
title41c="Expecting: ${YLO}
           -a always,exit -S arch=b32 -S umount -F auid>=1000 -F auid!=-1 -F key=privileged-umount
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
cci41="CCI-000130 CCI-000169 CCI-000172 CCI-002884"
stigid41="RHEL-09-654205"
severity41="CAT II"
ruleid41="SV-258215r1106381"
vulnid41="V-258215"

title42a="Successful/unsuccessful uses of the umount2 system call in RHEL 9 must generate an audit record."
title42b="Checking with: auditctl -l | grep umount2"
...
stigid42="RHEL-09-654210"
severity42="CAT II"
ruleid42="SV-258216r1102090"
vulnid42="V-258216"

title43a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/sudoers."
title43b="Checking with: auditctl -l | grep '/etc/sudoers[^.]'"
title43c="Expecting: ${YLO}-w /etc/sudoers -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
cci43="CCI-000018 CCI-000130 CCI-000135 CCI-000169 CCI-000172 CCI-001403 CCI-001404 CCI-001405 CCI-002130 CCI-000015 CCI-002884 CCI-002132"
stigid43="RHEL-09-654215"
severity43="CAT II"
ruleid43="SV-258217r1045436"
vulnid43="V-258217"

title44a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/sudoers.d/ directory."
title44b="Checking with: auditctl -l | grep /etc/sudoers.d"
title44c="Expecting: ${YLO}-w /etc/sudoers.d/ -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid44="RHEL-09-654220"
severity44="CAT II"
ruleid44="SV-258218r1101981"
vulnid44="V-258218"

title45a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/group."
title45b="Checking with: auditctl -l | egrep '(/etc/group)'"
title45c="Expecting: ${YLO}-w /etc/group -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid45="RHEL-09-654225"
severity45="CAT II"
ruleid45="SV-258219r1015130"
vulnid45="V-258219"

title46a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/gshadow."
title46b="Checking with: auditctl -l | egrep '(/etc/gshadow)'"
title46c="Expecting: ${YLO}-w /etc/gshadow -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid46="RHEL-09-654230"
severity46="CAT II"
ruleid46="SV-258220r1015131"
vulnid46="V-258220"

title47a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/opasswd."
title47b="Checking with: auditctl -l | egrep '(/etc/security/opasswd)'"
title47c="Expecting: ${YLO}-w /etc/security/opasswd -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid47="RHEL-09-654235"
severity47="CAT II"
ruleid47="SV-258221r1015132"
vulnid47="V-258221"

title48a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/passwd."
title48b="Checking with: auditctl -l | egrep '(/etc/passwd)'"
title48c="Expecting: ${YLO}-w /etc/passwd -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid48="RHEL-09-654240"
severity48="CAT II"
ruleid48="SV-258222r1015133"
vulnid48="V-258222"

title49a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/shadow."
title49b="Checking with: auditctl -l | egrep '(/etc/shadow)'"
title49c="Expecting: ${YLO}-w /etc/shadow -p wa -k identity
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
...
stigid49="RHEL-09-654245"
severity49="CAT II"
ruleid49="SV-258223r1015134"
vulnid49="V-258223"

title50a="RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /var/log/lastlog."
title50b="Checking with: auditctl -l | grep /var/log/lastlog"
title50c="Expecting: ${YLO}-w /var/log/lastlog -p wa -k logins
           NOTE: If the command does not return a line, or the line is commented out, this is a finding."${BLD}
cci50="CCI-000130 CCI-000135 CCI-000169 CCI-000172 CCI-002884"
stigid50="RHEL-09-654255"
severity50="CAT II"
ruleid50="SV-258225r1014990"
vulnid50="V-258225"
...
echo -e "${NORMAL}$hostname, $severity1, $controlid, $stigid1, $ruleid1, $cci1, $datetime, ${CYN}VERIFY, (See IA-2 Identification and Authentication (Organizational Users): V-258045)${NORMAL}"
...
nameformat="$(grep name_format /etc/audit/auditd.conf)"

if [[ $nameformat ]]
then
  format="$(echo $nameformat | awk -F " = " '{print $2}')"
  if [[ $format == "hostname" || $format == "fqd" || $format == "numeric" ]]
  then
    fail=0
    echo -e "${NORMAL}RESULT:    ${BLD}$nameformat${NORMAL}"
  else
    echo -e "${NORMAL}RESULT:    ${RED}$nameformat${NORMAL}"
  fi
else
...
if [[ $fail == 0 ]]
then
  echo -e "${NORMAL}$hostname, $severity2, $controlid, $stigid2, $ruleid2, $cci2, $datetime, ${GRN}PASSED, RHEL 9 labels all offloaded audit logs before sending them to the central log server.${NORMAL}"
else
  echo -e "${NORMAL}$hostname, $severity2, $controlid, $stigid2, $ruleid2, $cci2, $datetime, ${RED}FAILED, RHEL 9 does not label all offloaded audit logs before sending them to the central log server.${NORMAL}"
fi
...
echo -e "${NORMAL}$hostname, $severity3, $controlid, $stigid3, $ruleid3, $cci3, $datetime, ${CYN}VERIFY, (See CM-6 Configuration Settings: V-258169)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity4, $controlid, $stigid4, $ruleid4, $cci4, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-257796)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity5, $controlid, $stigid5, $ruleid5, $cci5, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258151)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity6, $controlid, $stigid6, $ruleid6, $cci6, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258152)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity7, $controlid, $stigid7, $ruleid7, $cci7, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258177)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity8, $controlid, $stigid8, $ruleid8, $cci8, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258178)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity9, $controlid, $stigid9, $ruleid9, $cci9, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258179)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity10, $controlid, $stigid10, $ruleid10, $cci10, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258180)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity11, $controlid, $stigid11, $ruleid11, $cci11, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258181)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity12, $controlid, $stigid12, $ruleid12, $cci12, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258182)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity13, $controlid, $stigid13, $ruleid13, $cci13, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258183)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity14, $controlid, $stigid14, $ruleid14, $cci14, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258184)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity15, $controlid, $stigid15, $ruleid15, $cci15, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258185)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity16, $controlid, $stigid16, $ruleid16, $cci16, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258186)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity17, $controlid, $stigid17, $ruleid17, $cci17, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258187)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity18, $controlid, $stigid18, $ruleid18, $cci18, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258188)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity19, $controlid, $stigid19, $ruleid19, $cci19, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258189)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity20, $controlid, $stigid20, $ruleid20, $cci20, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258190)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity21, $controlid, $stigid21, $ruleid21, $cci21, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258191)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity22, $controlid, $stigid22, $ruleid22, $cci22, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258192)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity23, $controlid, $stigid23, $ruleid23, $cci23, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258193)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity24, $controlid, $stigid24, $ruleid24, $cci24, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258194)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity25, $controlid, $stigid25, $ruleid25, $cci25, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258195)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity26, $controlid, $stigid26, $ruleid26, $cci26, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258196)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity27, $controlid, $stigid27, $ruleid27, $cci27, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258197)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity28, $controlid, $stigid28, $ruleid28, $cci28, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258198)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity29, $controlid, $stigid29, $ruleid29, $cci29, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258199)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity30, $controlid, $stigid30, $ruleid30, $cci30, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258200)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity31, $controlid, $stigid31, $ruleid31, $cci31, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258201)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity32, $controlid, $stigid32, $ruleid32, $cci32, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258202)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity33, $controlid, $stigid33, $ruleid33, $cci33, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258203)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity34, $controlid, $stigid34, $ruleid34, $cci34, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258204)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity35, $controlid, $stigid35, $ruleid35, $cci35, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258205)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity36, $controlid, $stigid36, $ruleid36, $cci36, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258206)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity37, $controlid, $stigid37, $ruleid37, $cci37, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258207)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity38, $controlid, $stigid38, $ruleid38, $cci38, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258208)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity39, $controlid, $stigid39, $ruleid39, $cci39, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258209)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity40, $controlid, $stigid40, $ruleid40, $cci40, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258210)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity41, $controlid, $stigid41, $ruleid41, $cci41, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258215)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity42, $controlid, $stigid42, $ruleid42, $cci42, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258216)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity43, $controlid, $stigid43, $ruleid43, $cci43, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258217)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity44, $controlid, $stigid44, $ruleid44, $cci44, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258218)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity45, $controlid, $stigid45, $ruleid45, $cci45, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258219)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity46, $controlid, $stigid46, $ruleid46, $cci46, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258220)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity47, $controlid, $stigid47, $ruleid47, $cci47, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258221)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity48, $controlid, $stigid48, $ruleid48, $cci48, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258222)${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity49, $controlid, $stigid49, $ruleid49, $cci49, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258223)${NORMAL}"
...
echo -e "${NORMAL}VULN ID:   $vulnid501${NORMAL}"
...
echo -e "${NORMAL}$hostname, $severity50, $controlid, $stigid50, $ruleid50, $cci50, $datetime, ${CYN}VERIFY, (See AU-12 Audit Generation: V-258225)${NORMAL}"
