...
2. conf  
   a. cst-rhel7\_2023.cfg - a list of RHEL 7 scripts to run.  
   b. cst-rhel8\_2024.cfg - a list of RHEL 8 scripts to run.  
   c. cst-rhel9\_2025.cfg - a list of RHEL 9 scripts to run.  
...
1. Sudo to root  
2. Copy the tar file to a network share or a location on the target host where script execution is permitted(i.e., /root/cst)  
